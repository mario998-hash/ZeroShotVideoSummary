...
from src.model.heuristic_prediction import heuristic_predicator_v11
...
def run(args):
    ...
    metric_dir = f'{work_dir}/EVAL_Sigma'
    ...
    for p1 in p1_range:
            for n in range(0,20):
                ...
                for i, split in enumerate(splites):
                    ...
                    heuristic_predicator_v11(test_data, output_file_train, p1, 1-p1, norm=n)
    ...
    for i, split in enumerate(splites):
        ...
        heuristic_predicator_v11(test_data, output_file_test, best_p1, 1-best_p1, norm=best_norm)
